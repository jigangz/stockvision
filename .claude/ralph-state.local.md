...
4. Work on these tasks for this iteration: **MIG-12,MIG-13,MIG-14**
...
5. Run verification after completing the batch: npm run typecheck
...
**Critical:** This is fresh-context mode. Complete ONLY the assigned tasks (MIG-12,MIG-13,MIG-14), commit, then EXIT.
